...
namespace Plugin.InAppBilling
{
	...
	public class InAppBillingImplementation : BaseInAppBilling
	{
        ...
        public override Task<InAppBillingPurchase> UpgradePurchasedSubscriptionAsync(string newProductId, string purchaseTokenOfOriginalSubscription, SubscriptionReplacementMode replacementMode = SubscriptionReplacementMode.WithTimeProration, CancellationToken cancellationToken = default) =>
